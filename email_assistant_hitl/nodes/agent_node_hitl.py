...
- Done: Signal that the workflow is complete after sending email or completing actions
...
5. Final step: After using tools to complete actions, call Done to signal completion.
